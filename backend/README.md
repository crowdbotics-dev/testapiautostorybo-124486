...
## Project Structure
    ...
    ├── testapiautostorybo_124486  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_124486`
...
2. Clone this repo and `cd testapiautostorybo_124486`
